              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" style="text-align:right" class="form-control" id="date" name="total" placeholder="Total" value="<?php echo number_format($grand, 2); ?>" onFocus="startCalc();" onBlur="stopCalc();"  tabindex="5" readonly>
